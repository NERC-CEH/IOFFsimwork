...
unstructured_summary_R_raw <- mapply(parallel_summary, simulation_output_unstructured[seq(1,10,2)],
                                     MoreArgs = list(type = "single"), SIMPLIFY = T)
unstructured_summary_R <- rowMeans(mapply(parallel_summary, simulation_output_unstructured[seq(1,10,2)], 
                                          MoreArgs = list(type = "single"), SIMPLIFY = T))
...
structured_summary_R_v_high_raw <- mapply(parallel_summary, simulation_output_structured_v_high[seq(1,10,2)], 
                                        MoreArgs = list(type = "single"), SIMPLIFY = T)
...
structured_summary_R_high_raw <- mapply(parallel_summary, simulation_output_structured_high[seq(1,10,2)], 
                                             MoreArgs = list(type = "single"), SIMPLIFY = T)
...
structured_summary_R_mid_raw <- mapply(parallel_summary, simulation_output_structured_mid[seq(1,10,2)], 
                                        MoreArgs = list(type = "single"), SIMPLIFY = T)
...
structured_summary_R_low_raw <- mapply(parallel_summary, simulation_output_structured_low[seq(1,10,2)], 
                                        MoreArgs = list(type = "single"), SIMPLIFY = T)
...
structured_summary_R_v_low_raw <- mapply(parallel_summary, simulation_output_structured_v_low[seq(1,10,2)], 
                                       MoreArgs = list(type = "single"), SIMPLIFY = T)
...
joint_summary_R_v_high_raw <- mapply(parallel_summary, simulation_output_joint_v_high[seq(1,10,2)], 
...
joint_summary_R_high_raw <- mapply(parallel_summary, simulation_output_joint_high[seq(1,10,2)], 
                                        MoreArgs = list(type = "joint"), SIMPLIFY = T)
...
joint_summary_R_mid_raw <- mapply(parallel_summary, simulation_output_joint_mid[seq(1,10,2)], 
                                   MoreArgs = list(type = "joint"), SIMPLIFY = T)
...
joint_summary_R_low_raw <- mapply(parallel_summary, simulation_output_joint_low[seq(1,10,2)], 
                                   MoreArgs = list(type = "joint"), SIMPLIFY = T)
...
joint_summary_R_v_low_raw <- mapply(parallel_summary, simulation_output_joint_v_low[seq(1,10,2)], 
                                  MoreArgs = list(type = "joint"), SIMPLIFY = T)
...
jointcov_summary_R_v_high_raw <- mapply(parallel_summary, simulation_output_jointcov_v_high[seq(1,10,2)], 
                                      MoreArgs = list(type = "joint"), SIMPLIFY = T)
...
jointcov_summary_R_high_raw <- mapply(parallel_summary, simulation_output_jointcov_high[seq(1,10,2)], 
                                   MoreArgs = list(type = "joint"), SIMPLIFY = T)
...
jointcov_summary_R_mid_raw <- mapply(parallel_summary, simulation_output_jointcov_mid[seq(1,10,2)], 
                                      MoreArgs = list(type = "joint"), SIMPLIFY = T)
...
jointcov_summary_R_low_raw <- mapply(parallel_summary, simulation_output_jointcov_low[seq(1,10,2)], 
                                      MoreArgs = list(type = "joint"), SIMPLIFY = T)
...
jointcov_summary_R_v_low_raw <- mapply(parallel_summary, simulation_output_jointcov_v_low[seq(1,10,2)], 
                                     MoreArgs = list(type = "joint"), SIMPLIFY = T)
