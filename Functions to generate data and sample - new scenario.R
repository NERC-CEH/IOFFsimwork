...
genDataFunctions_newscenario <- function(
  dim = NULL,
  lambda = NULL,
  env.beta = NULL,
  seed = NULL,
...
dat1 <- genData(dim = dim, lambda = lambda, env.beta = env.beta, seed = seed, kappa = kappa, sigma2x = sigma2x, plotdat = TRUE)
