...
unstructured_model_cov <- function(unstructured_data, 
                                   dat1, 
                                   biasfield, 
                                   dim = dim, 
                                   plotting=FALSE,
  ...
  if(plotting == TRUE){
    #~~~png("unstructured_model with bias covariate.png")
    ...
    image.plot(1:dim[1],1:dim[2],
               ...
               col=tim.colors(),
               xlab='', ylab='',
               main="Unstructured w bias-mean of r.f",
               asp=1#,
               #zlim=c(-4,1)
               )
...
#    points(unstructured_data[,1:2], pch=16)
    ...
    image.plot(1:dim[1],1:dim[2],
               ...
               col=tim.colors(),
               xlab='', ylab='', 
               main="Unstructured w bias-sd of r.f",
               asp=1)
    #~~~dev.off()
    }
