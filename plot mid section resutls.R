...
ggsave("Mid section results 1.png", p7, device = "png", width = 15, height = 18.5, units = "cm")
...
ggsave("Mid section results 2.png", p7, device = "png", width = 15, height = 18.5, units = "cm")
